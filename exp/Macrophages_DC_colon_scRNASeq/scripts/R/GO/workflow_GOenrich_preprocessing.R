...
dir <- paste(OUT_DIR, test.use, "GOenrichprep", sep="/")
dir.create(dir, showWarnings = FALSE)
GOenrichPreprocessingClusterByPairs(object = object, out.dir = OUT_DIR, res = res, prefix = prefix, clusters = new.cl.names, test.use = test.use, logFC.filt = logFC.filt, adjpval.filt = adjpval.filt)
GOenrichPreprocessingClusterVsAll(object = object, out.dir = OUT_DIR, res = res, prefix = prefix, clusters = new.cl.names, test.use = test.use, logFC.filt = logFC.filt, adjpval.filt = adjpval.filt)
